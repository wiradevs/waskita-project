...
{{-- ── Navbar ──────────────────────────────────────── --}}
<header id="main-navbar" class="fixed top-0 left-0 right-0 z-50">
        ...
        <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden md:flex items-center gap-4">
                ...
                <a href="https://wa.me/{{ $waNum }}"
                   target="_blank"
                   class="flex items-center gap-2 px-5 py-2.5 text-xs tracking-widest uppercase font-semibold border transition-all duration-300 hover:bg-charcoal hover:text-cream hover:border-charcoal"
                   style="border-color:#1C1917;color:#1C1917;font-family:'Inter',sans-serif;background:transparent;">
